...
cp -p ca.pem "${cert_dir}/"
cp -p ca-key.pem "${cert_dir}/"
cp -p server.pem "${cert_dir}/"
cp -p server-key.pem "${cert_dir}/"
cp -p client.pem "${cert_dir}/"
cp -p client-key.pem "${cert_dir}/"
cp -p peer.pem "${cert_dir}/"
cp -p peer-key.pem "${cert_dir}/"

CERTS=("ca.pem" "ca-key.pem" "server.pem" "server-key.pem" "client.pem" "client-key.pem" "peer.pem" "peer-key.pem")
